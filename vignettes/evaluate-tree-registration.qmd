...
These are used only to visualize the results. They take the true and predicted alignment values and use them to compute a scalar metric representing the quality.
