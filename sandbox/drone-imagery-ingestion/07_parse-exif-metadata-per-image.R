...
# Out
PROCESSED_EXIF_METADATA_PATH = "/ofo-share/drone-imagery-organization/metadata/2_intermediate/4_processed-exif"
...
# Output filepath
metadata_perimage_filepath = file.path(PROCESSED_EXIF_METADATA_PATH, paste0(mission_id_foc, ".csv"))
